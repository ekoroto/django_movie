# Generated by Django 3.2.7 on 2021-12-05 18:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.PositiveSmallIntegerField(default=0, verbose_name='Release year')),
                ...
                ('budget', models.PositiveIntegerField(default=0, help_text='amount in USD', verbose_name='Budget')),
                ('fees_usa', models.PositiveIntegerField(default=0, help_text='amount in USD', verbose_name='Fees in USA')),
                ('fees_world', models.PositiveIntegerField(default=0, help_text='amount in USD', verbose_name='Fees in USA')),
                ('url', models.SlugField(max_length=160, unique=True)),
                ('draft', models.BooleanField(default=False, verbose_name='Draft')),
                ('actors', models.ManyToManyField(related_name='movie_actor', to='movies.Actor', verbose_name='actor')),
